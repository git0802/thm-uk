<template>
    <div class="container__main__slot">
        <div class="container__head top-head">
            <app-left-drawer-burger/>
            <div class="title">
                Planner Setup
            </div>
        </div>
        <div class="planner-setup-page">
...
import Userpic from "../components/user/Userpic";
import GroceryStore from "../../js/views/GroceryStore";
import ReviewList from "../../js/components/modals/ModalReviewList/ReviewList";
...
export default {
    name: "PlannerSetup",
    components: {
        ModalWeeklyGoals, DragDrop, Userpic, GroceryStore, ReviewList,
    ...
    created() {
        ...
        this.$store.commit('planner/setCurrentDay', moment().format('YYYY-MM-DD'))
        this.$store.commit('planner/setSelectedDay', moment().format('YYYY-MM-DD'))
    },
    methods: {
        ...mapMutations({
