    ...
    <div class="food-block food-group">
        ...
        <div class="food-block__main">
            ...
            <div class="food-block__text">
                <span class="food-block__name food-block__name--height-40">{{item.product.name}}</span>
            ...
            <div class="food-block__info">
                ...
                <div class="food-block__show-group food-block__show-group--three">
                    <span class="title">{{ is_mobile ? 'Cal per Serv' : 'Calories per serving' }}</span>
                    <span class="text">{{item.product.calories}} cal.</span>
                </div>
            ...
            <div class="radio">
                <input-switch v-model="item.is_eaten" v-on:change="handleItemUpdate" />
            </div>
                ...
                <div class="food-group__wrap">
                    ...
                    <div class="food-group__block">
                        ...
                        <div class="food-group__block-group">
                            <span class="name" v-tooltip="dsh.name">{{ dsh.name }}</span>
                            <a v-if="dsh.url" :href="dsh.url" target="_blank" class="food__links food__links-group">
...
<script>
    ...
    export default {
        ...
        computed: {
            is_mobile(){
                return this.$store.getters['plannerUi/getMobile']
            }
        },
        methods: {
            numberToFixed(num){
