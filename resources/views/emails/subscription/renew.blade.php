                ...
                <center style="max-width: 600px; width: 100%;margin: 0 auto;">
                    <table border="0" cellpadding="0" cellspacing="0" style="margin: 0;padding: 0; width: 100%;text-align: center;">
                        ...
                        <tr style="display: block;margin-top: 20px;">
                            <td>
                                <span style="font-size: 18px;">Your subscription has been successfully renewed! We're so happy you're taking charge of your meal planning goals.</span>
                            </td>
                        </tr>
                        ...
                        <tr style="margin-top: 40px;display: block;">
                            <td style="display: inline-block">
                                <a href="{{ url("/") }}" style="background: #df2c65;color: #fff;width: 240px;display: inline-block;height: 50px;line-height: 48px;border-radius: 7px;font-size: 18px;" target="_blank">Go to meal planner</a>
                            </td>
                        </tr>
                    </table>
                </center>
