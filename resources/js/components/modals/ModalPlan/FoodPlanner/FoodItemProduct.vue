<template>
    ...
    <div class="food-block">
        <div class="food-block__main">
            <img :src="image" onerror="this.src='/images/no-product-image.jpg?t=0'" alt="" class="food-block__img">
            ...
            <div class="food-block__text">
                ...
                <div class="food-block__control">
                    ...
                    <div class="food-block__edit"
                        @click="editFood(); actionsModal({
                            name: 'modalFood',
                            action: 'open'
                        })"
                    >
            ...
            <button @click="deleteFoodIdChoosed(id)" type="button" class="food-block__delete">
